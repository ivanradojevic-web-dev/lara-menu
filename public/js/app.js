...
document.addEventListener('DOMContentLoaded', function (event) {
  document.querySelectorAll('.open-convert-box').forEach(function (item, index) {
    item.addEventListener("click", function () {
      var panel = document.querySelectorAll('.convert-box');
  ...
  document.querySelectorAll('.convert-valuta').forEach(function (item, index) {
    //convert event
    item.addEventListener("click", function () {
      var enterValuta = document.querySelectorAll('.enter-valuta')[index];
      ...
      if (enterValuta.value > 0.99) {
        axios.get('/api/convert', {
          ...
          discountPerecentage = response.data.discount_percentage; //show convert result
          ...
          var modal = document.querySelectorAll(".modal-valuta")[index]; //pre-payment info event

          btn.onclick = function () {
            document.querySelectorAll(".modal-valuta")[index].style.display = "block"; //submit payment event

            document.querySelectorAll('.transaction-form')[index].addEventListener('submit', function (e) {
              e.preventDefault();
